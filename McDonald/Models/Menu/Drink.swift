...
class Drink: MenuItem {
    ...
    init(name: String, price: Double,itemNumber:Int,  ingredients: [String],isIced: Bool,category: Category) {
        self.isIced = isIced
...
class Coffee: Drink {
    ...
    init(name: String, price: Double,itemNumber:Int, isIced: Bool, ingredients: [String],milk: Milk, sugar: Bool) {
        self.milk = milk
        self.sugar = sugar
